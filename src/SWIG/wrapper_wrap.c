...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__wrapper
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_saxpy_serial(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "saxpy_serial", 3, 3, swig_obj)) SWIG_fail;
  {
  ...
  ecode5 = SWIG_AsVal_float(swig_obj[2], &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "saxpy_serial" "', argument " "5"" of type '" "float""'");
  } 
  arg5 = (float)(val5);
  saxpy_serial(arg1,arg2,arg3,arg4,arg5);
...
SWIGINTERN PyObject *_wrap_saxpy_multithread(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  float *arg1 = (float *) 0 ;
  int arg2 ;
  float *arg3 = (float *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "saxpy_multithread", 4, 4, swig_obj)) SWIG_fail;
  {
    array1 = obj_to_array_no_conversion(swig_obj[0], NPY_FLOAT);
    if (!array1 || !require_dimensions(array1,1) || !require_contiguous(array1)
      || !require_native(array1)) SWIG_fail;
  ...
  ecode5 = SWIG_AsVal_float(swig_obj[2], &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "saxpy_multithread" "', argument " "5"" of type '" "float""'");
  } 
  arg5 = (float)(val5);
  ecode6 = SWIG_AsVal_int(swig_obj[3], &val6);
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "saxpy_multithread" "', argument " "6"" of type '" "int""'");
  } 
  arg6 = (int)(val6);
  saxpy_multithread(arg1,arg2,arg3,arg4,arg5,arg6);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "saxpy_serial", _wrap_saxpy_serial, METH_VARARGS, NULL},
	 { "saxpy_multithread", _wrap_saxpy_multithread, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
