...
for it in range(iterations):
    ...
    for size in N:
        ...
        z = saxpy_cython_multithread(a,x,y,z,threads)
...
# Saving the array
np.savetxt("/home/stefancc/Desktop/HPC/saxpy/Benchmark_Results/Saxpy_Python_Cython_Multithread_CPU.csv", Time_average, delimiter=",")